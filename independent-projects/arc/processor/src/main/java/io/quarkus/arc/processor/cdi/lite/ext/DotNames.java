...
class DotNames {
    ...
    static final DotName ANNOTATIONS = DotName.createSimple(AnnotationAttributes.class.getName());
    ...
    static final DotName ERRORS = DotName.createSimple(Messages.class.getName());
