 ...
 * <ul>
 * <li>{@code @ExactType("com.example.MyService") Collection<BeanInfo>}: information about beans with one exact type</li>
 * <li>{@code @SubtypesOf("com.example.MyService") Collection<BeanInfo>}: information about beans with at least one of the
 * subtypes</li>
 * <li>{@code @SupertypesOf("com.example.MyService") Collection<BeanInfo>}: information about beans with at least one of the
 * supertypes</li>
 ...
 * <ul>
 * <li>{@code @ExactType("com.example.MyService") Collection<ObserverInfo>}: information about observers observing one exact
 * type</li>
 * <li>{@code @SubtypesOf("com.example.MyService") Collection<ObserverInfo>}: information about observers observing at least one
 * of the
 * subtypes</li>
 * <li>{@code @SupertypesOf("com.example.MyService") Collection<ObserverInfo>}: information about observers observing at least
 * one of the
 * supertypes</li>
 ...
 * If you declare a parameter of shape {@code Collection<SomethingInfo>}, that is, without any annotation narrowing
 * down the query, that's a good sign you probably want to use {@code AppArchive} or {@code AppDeployment}.
 * <p>
