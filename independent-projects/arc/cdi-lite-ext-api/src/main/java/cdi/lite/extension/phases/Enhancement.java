 ...
 * <ul>
 * <li>{@code @ExactType("com.example.MyService") ClassInfo}: information about one exact class</li>
 * <li>{@code @ExactType("com.example.MyService") Collection<ClassInfo>}: information about one exact class, equivalent to
 * previous line</li>
 * <li>{@code @SubtypesOf("com.example.MyService") Collection<ClassInfo>}: information about all subclasses</li>
 * <li>{@code @SupertypesOf("com.example.MyService") Collection<ClassInfo>}: information about all superclasses</li>
 ...
 * <ul>
 * <li>{@code @ExactType("com.example.MyService") Collection<MethodInfo>}: information about methods declared on one exact
 * class</li>
 * <li>{@code @SubtypesOf("com.example.MyService") Collection<MethodInfo>}: information about methods declared on all
 * subclasses</li>
 * <li>{@code @SupertypesOf("com.example.MyService") Collection<MethodInfo>}: information about methods declared on all
 * superclasses</li>
 ...
 * <ul>
 * <li>{@code @ExactType("com.example.MyService") Collection<FieldInfo>}: information about fields declared on one exact
 * class</li>
 * <li>{@code @SubtypesOf("com.example.MyService") Collection<FieldInfo>}: information about fields declared on all
 * subclasses</li>
 * <li>{@code @SupertypesOf("com.example.MyService") Collection<FieldInfo>}: information about fields declared on all
 * superclasses</li>
 ...
 * <ul>
 * <li>{@code @ExactType("com.example.MyService") ClassConfig}: configurator for one exact class</li>
 * <li>{@code @ExactType("com.example.MyService") Collection<ClassConfig>}: configurator for the one exact class, equivalent to
 * previous line</li>
 * <li>{@code @SubtypesOf("com.example.MyService") Collection<ClassConfig>}: configurators for all subclasses</li>
 * <li>{@code @SupertypesOf("com.example.MyService") Collection<ClassConfig>}: configurators for all superclasses</li>
 ...
 * <ul>
 * <li>{@code @ExactType("com.example.MyService") Collection<MethodConfig>}: configurator for methods declared on one exact
 * class</li>
 * <li>{@code @SubtypesOf("com.example.MyService") Collection<MethodConfig>}: configurators for methods declared on all
 * subclasses</li>
 * <li>{@code @SupertypesOf("com.example.MyService") Collection<MethodConfig>}: configurators for methods declared on all
 * superclasses</li>
 ...
 * <ul>
 * <li>{@code @ExactType("com.example.MyService") Collection<FieldConfig>}: configurator for fields declared on one exact
 * class</li>
 * <li>{@code @SubtypesOf("com.example.MyService") Collection<FieldConfig>}: configurators for fields declared on all
 * subclasses</li>
 * <li>{@code @SupertypesOf("com.example.MyService") Collection<FieldConfig>}: configurators for fields declared on all
 * superclasses</li>
 ...
 * that is, without any annotation narrowing down the query, that's a good sign you probably want to use
 * {@code AppArchive} or {@code AppArchiveConfig}.
 * <p>
