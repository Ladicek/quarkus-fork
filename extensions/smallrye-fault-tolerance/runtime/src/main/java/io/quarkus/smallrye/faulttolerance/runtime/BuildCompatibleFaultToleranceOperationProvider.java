...
public class BuildCompatibleFaultToleranceOperationProvider implements FaultToleranceOperationProvider {
    ...
    public static class Creator implements SyntheticBeanCreator<BuildCompatibleFaultToleranceOperationProvider> {
        @Override
        public BuildCompatibleFaultToleranceOperationProvider create(
                CreationalContext<BuildCompatibleFaultToleranceOperationProvider> creationalContext,
                InjectionPoint injectionPoint, Map<String, Object> map) {

            String[] faultToleranceClasses = (String[]) map.get("classes");
            ...
            // TODO DeploymentException or DefinitionException?
            //  using DefinitionException for now, though previous Quarkus code used DeploymentException
    ...
    public static class EagerInitializationTrigger implements SyntheticObserver<AfterStartup> {
        @Override
